...
# Headless mode will get results as PASSED without opening any browser.

# pytest -s -v interactive_tests/test_headless_user_input_apple_search_module.py
# pytest -s -v interactive_tests/test_headless_user_input_apple_search_module.py --html=report.html
